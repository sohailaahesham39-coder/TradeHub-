...
class _EventsScreenState extends State<EventsScreen> with SingleTickerProviderStateMixin {
  ...
  final List<Event> _upcomingEvents = [
    ...
    Event(
      ...
      imageUrl:'https://i.pinimg.com/736x/30/b9/9e/30b99e3d6614366d8fcb63ece3d05fb7.jpg',
      ticketPrice: 79.99,
      totalAttendees: 120,
      organizerId: 'org002',
    ...
    Event(
      ...
      imageUrl: 'https://i.pinimg.com/736x/04/78/37/047837a4b4968634cebad216dfe19fc2.jpg',
      ticketPrice: 199.99,
      totalAttendees: 800,
      organizerId: 'org003',
    ...
    Event(
      ...
      imageUrl: 'https://i.pinimg.com/736x/84/c0/27/84c027c164789f4c14c450434871a068.jpg',
      ticketPrice: 129.99,
      totalAttendees: 300,
      organizerId: 'org006',
    ...
    Event(
      ...
      imageUrl: 'https://i.pinimg.com/736x/dc/0c/3b/dc0c3bb9cf56ef44c13a4329269ea8cf.jpg',
      ticketPrice: 99.99,
      totalAttendees: 200,
      organizerId: 'org007',
    ...
    Event(
      ...
      imageUrl: 'https://i.pinimg.com/736x/08/32/43/0832438296b32a4e5faafe252c9c9534.jpg',
      ticketPrice: 159.99,
      totalAttendees: 350,
      organizerId: 'org008',
    ...
    Event(
      ...
      imageUrl: 'https://i.pinimg.com/736x/6e/40/af/6e40af75337b6b9da677576490ba03fa.jpg',
      ticketPrice: 179.99,
      totalAttendees: 500,
      organizerId: 'org009',
  ...
  final List<Event> _myBookings = [
    Event(
      ...
      date: DateTime.now().add(const Duration(days: 7)),
      location: 'Business Innovation Center, Abu Dhabi',
      imageUrl: 'https://i.pinimg.com/736x/a0/6a/07/a06a077febe2f2908da103a78e70195f.jpg',
      ticketPrice: 79.99,
      totalAttendees: 120,
      organizerId: 'org002',
      organizerName: 'Logistics Professionals Association',
    ...
    Event(
      ...
      date: DateTime.now().add(const Duration(days: 20)),
      location: 'Tech Park, Sharjah',
      imageUrl: 'https://i.pinimg.com/736x/60/60/54/606054ba5f33f60f484fe21b4fe518f8.jpg',
      ticketPrice: 129.99,
      totalAttendees: 300,
      organizerId: 'org006',
      organizerName: 'Tech Pioneers Group',
    ...
    Event(
      ...
      imageUrl: 'https://i.pinimg.com/736x/76/ce/36/76ce36ca058012eb744337ff8e69a21f.jpg',
      ticketPrice: 89.99,
      totalAttendees: 150,
      organizerId: 'org010',
  ...
  final List<Event> _pastEvents = [
    Event(
      ...
      imageUrl: 'https://i.pinimg.com/736x/d1/96/f1/d196f1a83e805b116e35eb215e5e0728.jpg',
      ticketPrice: 99.99,
      totalAttendees: 180,
      organizerId: 'org004',
    ...
    Event(
      ...
      imageUrl: 'https://i.pinimg.com/736x/22/73/a1/2273a147a114fd2f913ad6452f943be4.jpg',
      ticketPrice: 129.99,
      totalAttendees: 220,
      organizerId: 'org005',
    ...
    Event(
      ...
      imageUrl: 'https://i.pinimg.com/736x/3a/7e/2c/3a7e2c08b90e0b6f019403c35899d5e1.jpg',
      ticketPrice: 139.99,
      totalAttendees: 600,
      organizerId: 'org011',
    ...
    Event(
      ...
      imageUrl: 'https://i.pinimg.com/736x/f4/67/f1/f467f18d516049f7a2ca128a080b2cef.jpg',
      ticketPrice: 69.99,
      totalAttendees: 100,
      organizerId: 'org012',
