...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  // Sample static data (for fields not yet dynamic)
  final Map<String, dynamic> _staticUserData = {
    'role': 'Business Owner',
    ...
    'rating': 4.8,
    'isPremium': true,
    'about': 'Experienced business owner specializing in international trade. Focusing on electronics, textile, and sustainable products.',
    'expertise': ['International Trade', 'Supply Chain Management', 'Market Development', 'Business Networking'],
    'profileImage': 'https://via.placeholder.com/150', // Added default profile image
  };
            ...
            child: Stack(
              children: [
                ...
                CustomScrollView(
                  ...
                  slivers: [
                    _buildProfileHeader(context, themeProvider, isArabic, authProvider),
                    SliverToBoxAdapter(
                      child: Padding(
                    ...
                    SliverToBoxAdapter(child: _buildTabContent(themeProvider, isArabic, authProvider)),
  ...
  Widget _buildProfileHeader(BuildContext context, ThemeProvider themeProvider, bool isArabic, UserAuthProvider authProvider) {
    ...
    return SliverAppBar(
      ...
      actions: [
        IconButton(
          ...
          onPressed: () {
            // Navigate to EditProfileScreen (You can create this screen later)
                  ...
                  children: [
                    Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: AppImageHandler.loadProfileImage(
                          imageUrl: authProvider.profileImage.isNotEmpty ? authProvider.profileImage : (_staticUserData['profileImage'] as String? ?? 'https://via.placeholder.com/150'),
                          size: 110.w,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (_staticUserData['isPremium'] as bool? ?? false)
                          Padding(
                    ...
                    SizedBox(height: 4.h),
                    Text(
                      '${_staticUserData['role'] ?? 'N/A'} | ${authProvider.companyName.isNotEmpty ? authProvider.companyName : 'Company Name'}',
                      style: TextStyle(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 4.w),
                              Text(
                                _staticUserData['location'] as String? ?? 'N/A',
  ...
  Widget _buildTabContent(ThemeProvider themeProvider, bool isArabic, UserAuthProvider authProvider) {
    switch (_selectedTabIndex) {
      case 0:
        return Padding(
          ...
          child: Column(
            children: [
              _buildAboutSection(themeProvider, isArabic),
              SizedBox(height: 24.h),
              _buildExpertiseSection(themeProvider, isArabic),
            ],
          ),
        );
      case 1:
      ...
      case 2:
        return Padding(
          padding: EdgeInsets.symmetric(horizontal: 16.w),
          child: _buildContactInfoSection(themeProvider, isArabic, authProvider),
        );
      default:
  ...
  Widget _buildAboutSection(ThemeProvider themeProvider, bool isArabic) {
    return Column(
      ...
      children: [
        ...
        _buildGlassmorphicContainer(
          ...
          child: Column(
            ...
            children: [
              Text(
                _staticUserData['about'] as String? ?? 'N/A',
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      // Navigate to Recommendations Screen (Create this screen if needed)
  ...
  Widget _buildExpertiseSection(ThemeProvider themeProvider, bool isArabic) {
    final expertise = _staticUserData['expertise'] as List<dynamic>? ?? [];
    return Column(
      crossAxisAlignment: isArabic ? CrossAxisAlignment.end : CrossAxisAlignment.start,
      children: [
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: GestureDetector(
                  onTap: () {
                    // Navigate to Add Skill Screen (Create this screen if needed)
    ...
    return Column(
      ...
      children: [
        ...
        Center(
          child: GestureDetector(
            onTap: () {
              // Navigate to All Activities Screen (Create this screen if needed)
  ...
  Widget _buildContactInfoSection(ThemeProvider themeProvider, bool isArabic, UserAuthProvider authProvider) {
    return Column(
      crossAxisAlignment: isArabic ? CrossAxisAlignment.end : CrossAxisAlignment.start,
      children: [
          ...
          child: Column(
            children: [
              _buildContactItem(
                ...
                value: _staticUserData['email'] as String? ?? 'N/A',
                themeProvider: themeProvider,
                onCopy: () {
                  Clipboard.setData(ClipboardData(text: _staticUserData['email'] as String? ?? ''));
              ...
              _buildContactItem(
                ...
                value: _staticUserData['phone'] as String? ?? 'N/A',
                themeProvider: themeProvider,
                onCopy: () {
                  Clipboard.setData(ClipboardData(text: _staticUserData['phone'] as String? ?? ''));
              ...
              _buildContactItem(
                ...
                value: _staticUserData['location'] as String? ?? 'N/A',
                themeProvider: themeProvider,
                onCopy: () {
                  Clipboard.setData(ClipboardData(text: _staticUserData['location'] as String? ?? ''));
              ...
              _buildContactItem(
                ...
                value: _formatMemberSince(_staticUserData['memberSince'] as DateTime? ?? DateTime.now(), isArabic),
                themeProvider: themeProvider,
                onCopy: () {
                  Clipboard.setData(ClipboardData(
                      text: _formatMemberSince(_staticUserData['memberSince'] as DateTime? ?? DateTime.now(), isArabic)));
    ...
    return Row(
      children: [
        Expanded(
          child: GestureDetector(
            onTap: () {
              // Navigate to Messaging Screen (Create this screen if needed)
...
// Placeholder for EditProfileScreen (Create this screen as needed)
